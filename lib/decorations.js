...
<svg viewBox="0 0 140 180" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
  ...
  const CHAPTERS = [
    ...
    { sel: "#recommend-mount",   num: "02", title: "<em>100%</em> 越えの推奨",  sub: "Walk-forward 検証で信頼性 ★★★ 以上", icon: "💎" },
    { sel: "#win5-mount",        num: "03", title: "<em>WIN5</em> 戦略",        sub: "堅め / 中波 / 万舟 — 3 段階で攻める", icon: "🎰" },
    { sel: "#all-races-mount",   num: "04", title: "本日の <em>全レース</em>",  sub: "発走時刻 × 信頼度 × 期待値で選別",   icon: "🐎" },
    { sel: ".section-card:has(#profit-grid)", num: "05", title: "買ったもの と <em>収支</em>", sub: "あなたの賭けと AI の判定の答え合わせ", icon: "💴" },
  ];
