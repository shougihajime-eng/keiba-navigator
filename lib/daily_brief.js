...
(function () {
  ...
  function quickStats() {
    ...
    try {
      ...
      if (!raw) return { betsCount: 0, recentRecovery: null };
      ...
      if (!real.length) return { betsCount: 0, recentRecovery: null };
      // 直近 30 件で回収率
      ...
      return { betsCount: real.length, recentRecovery: recovery };
    } catch {
      return { betsCount: 0, recentRecovery: null };
    }
  }
